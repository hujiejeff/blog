                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <div id="users_length" class="dataTables_length">
                                ...
                                <a href="{{route('tag_create')}}" class="btn btn-success pull-right">新建</a>
                            </div>
                        </div>
                        <div class="span6">
                    ...
                    <table id="users" class="table table-striped table-bordered dataTable"
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="users" rowspan="1"
                                ...
                                style="width: 238px;">标签名
                            </th>
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="users" rowspan="1"
                                colspan="1" aria-label="Status: activate to sort column ascending"
                                style="width: 182px;">包含标签的文章数
                            </th>
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="users" rowspan="1"
                                colspan="1" aria-label="Status: activate to sort column ascending"
                        ...
                        @foreach($tags as $tag)
                            <tr class="odd">
                                ...
                                <td class=" ">{{$tag->articles->count()}}</td>
                                ...
                                <td class=" ">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li><a href="{{url('tag/'.$tag->id)}}"><i class="icon-eye-open"></i>
                                                    查看</a></li>
                                            <li><a href="{{route('tag_update',['id' => $tag->id])}}"><i
                                        ...
                                        document.getElementById('delete-form').submit();"><i class="icon-trash"></i> 删除</a>
                                                <form id="delete-form" action="{{route('tag_delete',['id' => $tag->id])}}" style="display: none" method="post">
                                                    {{csrf_field()}}
                                                </form>
                                            </li>
                                        </ul>
